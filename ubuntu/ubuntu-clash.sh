...
function install_clash() {
    ...
    mkdir -p ~/clash
    cd ~/clash
    local download_url="https://github.com/mCapricorn/clash-for-linux-install.git"
    git clone "$download_url"
    cd ~/clash/clash-for-linux-install
    chmod +x ~/clash/clash-for-linux-install/install.sh
...
function main_menu() {
    clear
    echo "=====================Ubuntu clash安装========================="
    echo "节点社区 Discord 社群:https://discord.gg/SkdPv7s74W"
    echo "请选择要执行的操作:"
    echo "1. 安装"
    echo "2. 退出"
